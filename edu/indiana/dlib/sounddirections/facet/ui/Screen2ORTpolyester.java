...
public class Screen2ORTpolyester extends EditWindow {

	public JCheckBox thirtyPlusBox, offBrandBox, fungusBox, otherProblemsBox;
	...
	public Screen2ORTpolyester() {
		...
		JLabel characteristicsLabel = new JLabel("Format: Open Reel Tape-Polyester");
	...
	public void updateTheData() {		
		Main.theData.longPlayPoly = false;
		Main.theData.doublePlayPoly = false;
		Main.theData.triplePlayPoly = false;
		Main.theData.standardPoly = false;
		Main.theData.unknownDoubleTriplePoly = false;
		
		if (tapeThickness.getSelectedIndex() == 0) {
			Main.theData.standardPoly = true;
		}else if (tapeThickness.getSelectedIndex() == 1) {
			Main.theData.longPlayPoly = true;
		} else if (tapeThickness.getSelectedIndex() == 2) {
			Main.theData.doublePlayPoly = true;
		} else if (tapeThickness.getSelectedIndex() == 3) {
			Main.theData.triplePlayPoly = true;
		} else if (tapeThickness.getSelectedIndex() == 4) {
			Main.theData.unknownDoubleTriplePoly = true;
		}
		
		Main.theData.offBrand = offBrandBox.isSelected();
		Main.theData.stickyPoly = stickyRadio.isSelected();
		Main.theData.lossPoly = lossRadio.isSelected();
		Main.theData.fungus = fungusBox.isSelected();
		Main.theData.visibleMinorPoly = visibleMinor.isSelected();
		Main.theData.visibleModeratePoly = visibleModerate.isSelected();
		Main.theData.visibleSeverePoly = visibleSevere.isSelected();
